...
class CalculatorInput(BaseModel):               
    ...
    @field_validator("expression")  # 当有人想要给括号里指定的字段赋值时，必须先通过下面这个函数的检查
    ...
    def validate_variable_names(
        ...
        """变量名必须是普通 Python 标识符，禁止比如 user.password 或者 drop_table; 等可能引发安全漏洞的写法"""

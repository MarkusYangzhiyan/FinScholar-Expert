"""测试 DeepSeek Router Client 的主要路由链路。"""
...
async def test_deepseek_router_client_parses_yahoo_call() -> None:
    """Yahoo Tool Call 应转换成 RouterDecision。"""
    ...
    router_client = DeepSeekRouterClient(
